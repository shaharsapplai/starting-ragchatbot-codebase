...
class TestAIGeneratorBasic:
    ...
    def test_generate_response_with_tools(
        self, mock_ai_generator, mock_text_response, tool_manager
    ):
        ...
        result = mock_ai_generator.generate_response(query="What is AI?", tools=tools)
    ...
    def test_generate_response_with_conversation_history(
        self, mock_ai_generator, mock_text_response
    ):
...
class TestAIGeneratorToolUse:
    ...
    def test_handle_tool_execution_calls_correct_tool(
        self,
        mock_ai_generator,
        mock_tool_use_response,
        mock_text_response,
        ...
        mock_ai_generator.client.messages.create = Mock(
            side_effect=[
                mock_tool_use_response(
                    tool_name="search_course_content", tool_input=tool_input
                ),
    ...
    def test_tool_result_sent_in_followup_message(
        self,
        mock_ai_generator,
        mock_tool_use_response,
        mock_text_response,
    ...
    def test_returns_final_response_text(
        self,
        mock_ai_generator,
        mock_tool_use_response,
        mock_text_response,
    ...
    def test_handles_multiple_tool_calls(
        self, mock_ai_generator, mock_text_response, tool_manager
    ):
